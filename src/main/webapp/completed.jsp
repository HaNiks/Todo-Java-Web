                    ...
                    <div class="card-body p-5">
                        <form class="d-flex mb-4" action="addTask" method="post">
                            <div class="d-flex form-outline flex-fill align-items-center">
                                <input type="text" name="taskName" class="form-control" placeholder="Enter task"
                                       required=""/>
                            </div>
                        ...
                        <div class="tab-content" id="ex1-content">
                            <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel"
                                ...
                                <ul class="list-group mb-0">
                                    ...
                                    %>
                                    <li class="list-group-item d-flex justify-content-between border-0 mb-2 rounded bg-info text-white"
